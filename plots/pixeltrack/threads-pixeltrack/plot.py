...
#print("s threads", serialThreads)
#print("s utilization", serialUtilization)
...
ax2.plot(cudaThreads, cudaUtilization, marker="o", label="CUDA", color='green')
    # ratio
#ax2.plot(ratioThreads, ratioThroughput, marker="o", label="SERIAL/TBB", color="red")#, facecolors='none', color='orange')
...
#y = np.concatenate((serialThroughput, tbbThroughput, mtThroughput, cudaThroughput))  makes the plot crowded

#ax3.set_yticks(ratioThroughput)
#ax3.set_yticklabels(ratioThroughput)

#ax4.set_yticks(ratioThroughput8)
#ax4.set_yticklabels(ratioThroughput8)
