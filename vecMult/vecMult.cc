...
const int rows1 = 8;	// # rows of array 1
const int rows2 = 8;	// should match cols1
const int cols1 = 8;	// # cols of array 1
const int cols2 = 8;
...
// threads and blocks
const int blocksX = 2;		// recall that each block resembles a kernel call
const int blocksY = 2;
const int threadsPerBlockX = 4;		// in cpu backend this will be "elements"
const int threadsPerBlockY = 4;
...
template <typename T>
void verify(T const& a, T const& b, T const& result){
