...
const int rows1 = 128;	// # rows of array 1
const int rows2 = 128;	// should match cols1
const int cols1 = 128;	// # cols of array 1
const int cols2 = 128;
...
// threads and blocks
const int blocksX = 16;		// recall that each block resembles a kernel call
