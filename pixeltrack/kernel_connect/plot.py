...
# plot error
#ax1.errorbar(serialThresh, serialTime, fmt='o', yerr=serialStdev, ms=0, capsize=10, color="blue")
#ax1.errorbar(tbbThresh, tbbTime, fmt='o', yerr=tbbStdev, ms=0, capsize=10, color="orange")
